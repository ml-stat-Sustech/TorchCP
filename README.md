...
| 2005 | **[Inductive Confidence Machines for Regression](https://link.springer.com/chapter/10.1007/3-540-36755-1_29)** **[Guaranteed Coverage Prediction Intervals with Gaussian Process Regression](https://arxiv.org/abs/2310.15641)** **[Reliable Prediction Intervals with Regression Neural Networks](https://arxiv.org/abs/2312.09606)** |                      |                                                                            | regression.score.abs regression.score.norabs |                     |
...
@article{JMLR:v26:24-2141,
  ...
  number  = {266},
  pages   = {1--25},
  url     = {http://jmlr.org/papers/v26/24-2141.html}
}
```
